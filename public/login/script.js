...
userBtn.addEventListener("click",(e)=>{
    if(userNameInput.value === ""){
        ...
        fetch("app.js",{
            method: "POST",
            body: data
        }).then(response => response.json()).then(info => console.log(info)).catch(error => console.log(error));
    }
})
const messages = ["Oh Please don't destroy the server <img src='/img/scared.gif' width='40px' alt='please?'>","please Noooooo..","Uhhhh Execuse Me?","このバカ！>_< <img src='/img/pout-girl.gif' width='40px' alt='i hate you'>"]
